...
const resize = (htmlElement) => () => {
    const { PI } = Math, { clientWidth, clientHeight, style } = htmlElement, curve = (0, squoval_js_1.Squoval)(clientWidth / clientHeight), step = (2 * PI) / (clientWidth + clientHeight), initial = curve(step / 2), digits = 3;
